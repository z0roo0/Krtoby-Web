...
class Hotel_Booking_Lite_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function hotel_booking_lite_loadClassLoader($class)
    {
    ...
    public static function hotel_booking_lite_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
