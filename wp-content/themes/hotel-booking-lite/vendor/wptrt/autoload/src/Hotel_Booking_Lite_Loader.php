...
class Hotel_Booking_Lite_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function hotel_booking_lite_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function hotel_booking_lite_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function hotel_booking_lite_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function hotel_booking_lite_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->hotel_booking_lite_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function hotel_booking_lite_load( $class ) {
