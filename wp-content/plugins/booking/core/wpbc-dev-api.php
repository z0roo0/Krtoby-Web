 ...
 *                                                                                                                      //FixIn: 9.5.3.3
	...
	do_action( 'wpbc_empty_trash' $params, $action_result );	            // where $params is array,  which  contain	$params['booking_id'], and 	$action_result array and have $action_result['after_action_result'], which contains a boolean value of the result of an operation.
	...
	do_action( 'wpbc_duplicate_booking_to_other_resource' $params, $action_result );	// where $params is array,  which  contain	$params['booking_id'], and 	$action_result array and have $action_result['after_action_result'], which contains a boolean value of the result of an operation.
